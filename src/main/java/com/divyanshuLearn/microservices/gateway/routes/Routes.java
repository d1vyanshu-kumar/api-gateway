package com.divyanshuLearn.microservices.gateway.routes;
...
public class Routes {
    ...
    public RouterFunction<ServerResponse> fallBackRoute(){
        return route("fallbackRoute")
                .GET("/fallbackRoute", request -> ServerResponse.status(HttpStatus.SERVICE_UNAVAILABLE).body("Service is down, please try after sometime"))
                .build();
    }
}
